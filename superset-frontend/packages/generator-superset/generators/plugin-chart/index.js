...
import { kebabCase, upperFirst, startCase, camelCase } from 'lodash';
...
export default class extends Generator {
  async prompting() {
    ...
    this.answers = await this.prompt([
      ...
      },
      {
        ...
        // Default to current folder name
        default: upperFirst(
          startCase(this.appname.replace('superset plugin chart', '').trim()),
        ),
      },
      {
        type: 'list',
  ...
  writing() {
    ...
    const pluginName = startCase(camelCase(this.answers.packageName));
